...
export const postVotes = pgTable(
  ...
  (table) => [index("post_vote_idx").on(table.postId, table.authId)],
);

// Suggestion comment votes table
export const commentVotes = pgTable(
  ...
  (table) => [index("comment_vote_idx").on(table.commentId, table.authId)],
);
