  ...
  const features = [
    {
      ...
      description:
        "Share and discover authentic reviews, ratings, and experiences from real students.",
      icon: "🎓",
    },
    {
    ...
    },
    {
      ...
      description:
        "Upvote helpful content, build reputation, and contribute to a thriving student community.",
      icon: "⭐",
    },
  ];
      ...
      <div className="text-center space-y-8">
        ...
        <div className="space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-foreground">
            Loop is a platform of the student, by the student, and for the
            student.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
          ...
          <Button size="lg" variant="outline" className="w-full sm:w-auto">
            ...
            <a href="mailto:thesushilsharma@proton.me">Contact Me</a>
          </Button>
        </div>
      </div>
