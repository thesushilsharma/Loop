    ...
    if (!university) {
        return (
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-2xl font-bold text-center text-foreground">University not found</h1>
            </div>
        );
    }
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <Button asChild className="w-full sm:w-auto">
                        <a href={university.websiteLink} target="_blank" rel="noopener noreferrer">
                            Visit Website
                        </a>
                    </Button>
                    <Button asChild variant="outline" className="w-full sm:w-auto">
                        <a href={university.linkedinLink!} target="_blank" rel="noopener noreferrer">
                            LinkedIn
                        </a>
                    </Button>
                </div>
            ...
            <div className="space-y-6">
                ...
                <div className="bg-background p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold mb-4 text-primary">Quick Info</h2>
                    ...
                    <div className="flex items-center gap-4 mt-4">
                        <StarRating rating={Number(university.rating)} className="text-primary" />
...
{/* Tabs */ }
    <Tabs defaultValue="reviews" className="w-full">
        ...
        <TabsContent value="discussions">
            <div className="p-6 bg-background rounded-lg shadow-md mt-4">
                <p className="text-foreground">Discussions will be displayed here</p>
            </div>
        </TabsContent>
    </Tabs>
        </div >
